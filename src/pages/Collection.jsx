            ...
            <AnimatePresence mode="wait">
                {view === 'editorial' ? (
                    ...
                    >
                        ...
                        <div className="relative z-10 text-center flex flex-col items-center px-6">
                            <motion.div
                                ...
                                className="mb-12"
                            >
                                <h1 className="text-6xl sm:text-7xl md:text-[14rem] font-serif tracking-[0.2em] md:tracking-[0.3em] leading-none text-white/[0.03] inline-block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none whitespace-nowrap uppercase">
                                    {collection.name}
                                </h1>
                                <h2 className="text-4xl sm:text-5xl md:text-8xl font-serif tracking-[0.1em] md:tracking-[0.15em] text-white relative z-20 uppercase leading-tight">
                                    ...
                                    <span className="text-[10px] sm:text-xs md:text-sm block mt-4 md:mt-8 tracking-[0.4em] text-white/40 font-sans italic lowercase">Collection</span>
                                </h2>
                            </motion.div>
                            ...
                            <motion.p 
                                ...
                                className="text-[10px] md:text-xs tracking-[1em] text-gold-500 mb-20 font-black uppercase max-w-lg leading-loose"
                            >
                            ...
                            >
                                <span className="relative z-10 text-[10px] tracking-[0.5em] font-black flex items-center text-white group-hover:text-gold-400">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-32 border-b border-white/10 pb-8 md:pb-16 relative">
                            ...
                            <div className="mt-12 md:mt-0 flex flex-col items-end">
                                ...
                                <p className="text-[10px] tracking-[0.4em] uppercase text-white font-black">Collection</p>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center px-2">
                                        ...
                                        {product.sale_price ? (
                                            <div className="flex flex-col items-center">
                                                <div className="flex items-center space-x-3 mb-1">
                                                    <span className="text-[10px] md:text-[11px] font-black tracking-[0.2em] md:tracking-[0.3em] uppercase text-gold-500">
                                                        {formatCurrency(product.sale_price, activeCurrency, rates, symbols)}
                                                    </span>
                                                    <span className="text-[8px] md:text-[9px] line-through text-white/30 tracking-widest">
                                        ...
                                        <Link 
                                            ...
                                            className="mt-6 md:mt-8 text-[9px] md:text-[8px] tracking-[0.3em] md:tracking-[0.4em] uppercase text-white/40 hover:text-gold-400 transition-colors font-bold border-b border-white/10 pb-1.5"
                                        >
