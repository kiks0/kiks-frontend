      ...
      {isOpen && (
        ...
        >
          <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '24px' }}>
            <p style={{ fontSize: '11px', letterSpacing: '0.2em', color: 'rgba(0,0,0,0.5)', textTransform: 'uppercase', fontWeight: 300 }}>
              <button
                onClick={() => handleAction('/login')}
                onMouseEnter={() => setHoverSign(true)}
                onMouseLeave={() => setHoverSign(false)}
                style={{
                  color: hoverSign ? '#000000' : '#000000',
                  fontWeight: 700,
              ...
              <button
                ...
                style={{
                  color: hoverCreate ? '#000000' : '#000000',
                  fontWeight: 700,
                  textDecoration: 'underline',
                  textUnderlineOffset: '4px',
                  background: 'none',
