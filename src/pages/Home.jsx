...
const Home = () => {
  ...
  return (
    <div className="bg-dark-900 min-h-screen text-white relative">
      ...
      {/* Product 1: ELITE */}
      <section className="relative py-4 md:py-32 overflow-hidden bg-[#050505]">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-[1400px]">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-16 lg:gap-32">

            {/* Mobile Header: Name on Top */}
            <div className="md:hidden text-center mb-2">
              <h2 className="text-4xl font-serif font-light tracking-[0.15em] leading-none text-white uppercase">
                ELITE
              </h2>
              <p className="text-gold-500/80 text-[9px] tracking-[0.4em] uppercase font-bold mt-1">Extrait de Parfum</p>
            </div>
            ...
            >
              ...
              <div className="relative z-10 space-y-4 md:space-y-8 w-full mt-4 md:mt-0">
                {/* Header (Desktop Only) */}
                ...
                {/* Description Block */}
                <div className="space-y-4 md:space-y-6 max-w-lg mx-auto md:mx-0">
                  <p className="hidden md:block text-gold-500/80 text-[11px] tracking-[0.4em] uppercase font-bold">Extrait de Parfum</p>
                  <div className="space-y-2">
                    <p className="text-[9px] tracking-[0.3em] uppercase text-white/40 font-bold mb-1">Elite Profile</p>
                    <p className="text-[11px] md:text-base text-gray-400 leading-relaxed tracking-widest font-light italic opacity-80">
                  ...
                  <div className="pt-4">
                    <Link 
                      ...
                      className="inline-block text-[10px] tracking-[0.4em] uppercase font-bold text-white border-b border-white/20 pb-1 hover:border-gold-500 hover:text-gold-500 transition-all"
                    >
                ...
                <div className="grid grid-cols-2 gap-y-6 gap-x-12 border-t border-white/10 pt-8 w-full max-w-md mx-auto md:mx-0">
                  <div className="space-y-2">
                    <span className="text-[9px] text-white/30 uppercase tracking-[0.3em] font-bold">Strength</span>
                    <p className="text-[10px] text-white tracking-[0.2em] uppercase font-medium">Strong & Rich</p>
                  </div>
                  <div className="space-y-2">
                    <span className="text-[9px] text-white/30 uppercase tracking-[0.3em] font-bold">Main Notes</span>
                    <p className="text-[10px] text-white tracking-[0.2em] uppercase font-medium">Oud & Saffron</p>
                  </div>
                </div>
              </div>
            </motion.div>
