...
const Security = () => {
    ...
    const handleUpdateEmail = async (e) => {
        ...
        // Strict Email Regex - Only Trusted Providers
        const emailRegex = /^[a-zA-Z0-9._%+-]+@(gmail|icloud|outlook|yahoo|hotmail|protonmail|me)\.(com|net|org|edu|gov|io|luxury)$/i;
        if (!emailRegex.test(emailForm.newEmail.toLowerCase().trim())) {
            setEmailStatus({ type: 'error', msg: 'Please enter a valid, trusted email address (e.g. name@gmail.com).' });
                ...
                <div className="space-y-12 md:space-y-20">
                    ...
                    >
                        <div className="space-y-2">
                            <h2 className="text-[12px] font-bold tracking-[0.2em] uppercase text-black/40">Login email</h2>
                            <div className="w-full h-px bg-black/10"></div>
                        </div>

                        <p className="text-[11px] md:text-[12px] text-black/70 leading-relaxed max-w-lg font-light">
                        ...
                        <form onSubmit={handleUpdateEmail} className="space-y-8">
                            <div className="space-y-6">
                                ...
                                <div className="space-y-1 relative">
                                    <label className="text-[10px] tracking-[0.2em] text-black/50 uppercase block">Email</label>
                                    <input 
                                        type="email"
                                        value={emailForm.newEmail}
                                        onChange={(e) => setEmailForm({...emailForm, newEmail: e.target.value})}
                                        className="w-full bg-transparent border-b border-black/10 py-2 text-[13px] focus:border-black transition-colors outline-none font-medium"
                                        required
                                    />
                                </div>

                                <p className="text-[11px] text-black/50 italic font-light">To modify your email, please enter your current password.</p>
                            ...
                            {emailStatus.msg && (
                                <div className={`flex items-center gap-2 p-3 border font-bold ${emailStatus.type === 'success' ? 'bg-green-500/5 border-green-500/20 text-green-500' : 'bg-red-600/5 border-red-600/20 text-red-600'} text-[10px] tracking-widest uppercase`}>
                    ...
                    >
                        <div className="space-y-2">
                            <h2 className="text-[12px] font-bold tracking-[0.2em] uppercase text-black/40">Password</h2>
                            <div className="w-full h-px bg-black/10"></div>
                        </div>
