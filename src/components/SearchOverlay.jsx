...
const SearchOverlay = ({ isOpen, onClose }) => {
  ...
  const sitePages = [
    ...
    { id: 'p7', title: 'Login', type: 'Secure Access', link: '/login', category: 'AUTH', keywords: ['signin', 'login', 'access', 'enter', 'profile'] },
    { id: 'p8', title: 'Register', type: 'Identity Verification', link: '/register', category: 'AUTH', keywords: ['signup', 'register', 'join', 'create account'] },
