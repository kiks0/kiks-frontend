                ...
                {selectedReviewImage && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative max-w-3xl w-full bg-[#0a0a0a] border border-white/10 overflow-hidden flex flex-col md:flex-row shadow-2xl max-h-[85vh] md:max-h-none overflow-y-auto md:overflow-visible"
                        ...
                        >
                            ...
                            {/* Image Section */}
                            <div className="w-full md:w-3/5 h-[35vh] sm:h-[40vh] md:h-[60vh] bg-black flex items-center justify-center overflow-hidden border-b md:border-b-0 md:border-r border-white/10 flex-shrink-0">
                                <img
                            ...
                            {/* Info Section */}
                            <div className="w-full md:w-2/5 p-5 sm:p-6 flex flex-col justify-between bg-gradient-to-b from-[#0a0a0a] to-black overflow-y-auto">
                                <div>
                                ...
                                <div className="mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-white/5">
                                    <div className="flex items-center space-x-3">
                                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white/5 border border-white/10 flex items-center justify-center text-[9px] sm:text-[10px] font-bold text-white uppercase italic">
                                            {selectedReviewImage.review.first_name?.[0]}
                                        </div>
                                        <div>
                                            <p className="text-[8px] sm:text-[9px] text-white/80 uppercase tracking-[0.2em] font-bold">
                                                {selectedReviewImage.review.first_name} {selectedReviewImage.review.last_name}
                                            </p>
                                            <p className="text-[7px] sm:text-[8px] text-white/40 uppercase tracking-[0.1em] mt-0.5">
