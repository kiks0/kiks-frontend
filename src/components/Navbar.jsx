...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed w-full z-[99999] transition-all duration-700 ${isScrolled || isAccountPage ? 'bg-black/90 backdrop-blur-md py-1.5 md:py-2.5 shadow-2xl text-white' : 'bg-transparent py-2.5 md:py-4 text-white'}`}>
